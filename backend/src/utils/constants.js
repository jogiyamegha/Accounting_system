...
const NotificationTypes = (function () {
  ...
  NotificationTypes.serviceOverdue = 8;
...
const ValidationMsg = (function () {
  ...
  ValidationMsg.ServiceNotEnded =
    "Opps, can not assign service as past service is running!";
  ValidationMsg.ClientNotAssignService =
    "this service is not assigned to client..";
  ValidationMsg.ServiceIsCompleted =
    "service is already completed, You can not De-assign.";
  ValidationMsg.ServiceIsCompletedToDeassign =
    "Service Is Completed so you can not de-assign it!";
