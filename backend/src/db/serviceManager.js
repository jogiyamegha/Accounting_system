...
const allServices = [
    [TableNames.Document, require('./services/DocumentService').deleteMyReferences],
    [TableNames.Invoice, require('./services/InvoiceService').deleteMyReferences],
    [TableNames.Client, require("./services/ClientService").deleteMyReferences],
    [TableNames.Company, require("./services/CompanyService").deleteMyReferences],
];
