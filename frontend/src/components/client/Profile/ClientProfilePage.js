                ...
                <div className="info-grid">
                    ...
                    <p>
                        ...
                        {profile.company?.address
                            ? `${profile.company.address.addressLine1 || ""}, ${profile.company.address.addressLine2 || ""
                            }, ${profile.company.address.street || ""}, ${profile.company.address.landmark || ""
                            }, ${profile.company.address.city || ""}, ${profile.company.address.state || ""
                            }, ${profile.company.address.zipcode || ""}, ${profile.company.address.country || ""
                            }`
                            : "N/A"}
                    </p>
                </div>
