    ...
    return (
        <div className={styles.pageWrapper}>
            ...
            <div className={styles.mainContent}>
                <h1 className={styles.pageTitle}>Clients Applied</h1>
                ...
                {loading ? (
                    ...
                    <table className={styles.card}>
                        <thead>
                            <tr>
                                <th className={styles.clientName}>Client Name</th>
                                <th className={styles.clientEmail}>Email</th>
                                <th className={styles.clientMeta}>Start Date</th>
                                <th className={styles.clientMeta}>End Date</th>
                                <th className={styles.clientMeta}>Status</th>
                                <th className={styles.clientMeta}>Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            {clients.map((client) =>
